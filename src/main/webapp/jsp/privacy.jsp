                    ...
                    <div class="p-header-void min-vh-100 container">
                        <div class="d-md-flex align-items-center justify-content-around">
                            <div class="mega-title-container my-5">
                                <h1 class="mega-title"><strong>Privacy Policy</strong></h1>
                            </div>
                            <div class="text-center">
                                <img src="<c:out value="${baseUri}" />/media/gdpr.svg" class="landing-image"
                                alt="GDPR">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-header-void min-vh-100 container">
                        <div class="mt-5">
                            ...
                            <p>
                                ...
                                agree to the collection and use
                                of information in accordance with this Privacy Policy.
                            </p>
                            <h1 class="text-primary my-5">Interpretation and Definitions</h1>
                            <h2 class="text-warning my-3">Interpretation</h2>
                            <p>
                            ...
                            <ul>
                                ...
                                <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our"
                                    in this Agreement)
                                    refers to HyperGroup, Via Gradenigo 6/b 35131 - Padova (PD).
                                </li>
                                <li><strong>Cookies</strong> are small files that are placed on Your computer, mobile
                                    device or
                                    any other
                                    device by a website, containing the
                                    details of Your browsing history on that website among its many uses.
                                </li>
                                <li><strong>Country</strong> refers to: Italy
                                </li>
                                ...
                                <li><strong>Service</strong> refers to the Website.
                                </li>
                                <li><strong>Service Provider</strong> means any natural or legal person who processes
                                    the data on
                                    behalf
                                    of the Company. It refers to
                                    third-party companies or individuals employed by the Company to facilitate the
                                    Service, to provide the Service on behalf
                                    of the Company, to perform services related to the Service or to assist the
                                    Company
                                    in analyzing how the Service is
                                    used.
                                </li>
                                <li><strong>Usage Data</strong> refers to data collected automatically, either generated
                                    by the
                                    use of
                                    the Service or from the Service
                                    infrastructure itself (for example, the duration of a page visit).
                                </li>
                                <li><strong>Website</strong> refers to HyperU, accessible from
                                    <c:out value="${baseUri}" />
                                </li>
                            ...
                            <h1 class="text-primary my-5">Collecting and Using Your Personal Data</h1>
                            <h2 class="text-warning my-3">Types of Data Collected</h2>
                            <h3 class="text-success">Personal Data</h3>
                            <p>While using Our Service, We may ask You to provide Us with certain personally
                                identifiable information that can be used
                                to contact or identify You. Personally identifiable information may include, but is not
                                limited to:
                            </p>
                            <ul>
                                <li>Email address</li>
                            ...
                            <h3 class="text-success">Usage Data</h3>
                            <p>
                            ...
                            <p>
                                ...
                                but not limited to, the type of mobile device You use, Your mobile device unique ID, the
                                IP address of Your mobile
                            ...
                            <p>
                                ...
                                or when You access the Service by
                                or through a mobile device.
                            </p>
                            <h3 class="text-success">Tracking Technologies and Cookies</h3>
                            <p>
                                We use Cookies and similar tracking technologies to track the activity on Our Service
                                and store certain information.
                                Tracking technologies used are beacons, tags, and scripts to collect and track
                                information and to improve and analyze
                            ...
                            <ul>
                                <li><strong>Cookies or Browser Cookies</strong>. A cookie is a small file placed on Your
                                    ...
                                    some parts of our Service. Unless you have adjusted Your browser setting so that it
                                    will refuse Cookies, our Service may
                                    use Cookies.</li>
                                <li><strong>Flash Cookies</strong>. Certain features of our Service may use local stored
                                    ...
                                    available
                                    <a target="_blank"
                                        href="https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_">here</a>
                                </li>
                                <li>
                                    ...
                                    Company, for example, to count users
                            ...
                            <p>
                                ...
                                when You go offline, while Session Cookies are deleted as soon as You close Your web
                            ...
                            <ul>
                                <li><strong>Necessary/Essential Cookies</strong>
                                    <ul>
                                        ...
                                        <li>Purpose: These Cookies are essential to provide You with services available
                                            through the Website and to enable You to use
                                            some of its features. They help to authenticate users and prevent fraudulent
                                ...
                                <li><strong>Cookies Policy/Notice Acceptance Cookies</strong>
                                    <ul>
                                        ...
                                        <li>Administered by: Us</li>
                                        <li>Purpose: These Cookies identify if users have accepted the use of cookies on
                                            the Website.</li>
                                    </ul>
                                </li>
                                <li><strong>Functionality Cookies</strong>
                                    <ul>
                                        <li>Type: Persistent Cookies</li>
                                        <li>Administered by: Us</li>
                                        <li>Purpose: These Cookies allow us to remember choices You make when You use
                                            the Website, such as remembering your login details or
                                            language preference. The purpose of these Cookies is to provide You with a
                                            more personal experience and to avoid You
                            ...
                            <p>For more information about the cookies we use and your choices regarding cookies, please
                                visit our Cookies Policy or the
                                Cookies section of our Privacy Policy.</p>
                            <h2 class="text-warning my-3">Use of Your Personal Data</h2>
                            ...
                            <ul>
                                ...
                                <li><strong>To manage Your Account</strong>: to manage Your registration as a user of
                                    the Service. The
                                    Personal Data You provide can give You
                                ...
                                <li><strong>To contact You</strong> To contact You by email regarding updates or
                                    informative
                                ...
                                <li><strong>For other purposes</strong> We may use Your information for other purposes,
                                    such as data
                                    analysis, identifying usage trends,
                            ...
                            <h2 class="text-warning">Retention of Your Personal Data</h2>
                            <p>
                                The Company will retain Your Personal Data only for as long as is necessary for the
                                purposes set out in this Privacy
                                Policy. We will retain and use Your Personal Data to the extent necessary to comply with
                                our legal obligations (for
                            ...
                            <p>
                                ...
                                generally retained for a shorter
                                period of time, except when this data is used to strengthen the security or to improve
                                the functionality of Our Service,
                                or We are legally obligated to retain this data for longer time periods.
                            </p>
                            <h2 class="text-warning">Transfer of Your Personal Data</h2>
                            <p>
                                Your information, including Personal Data, is processed at the Company's operating
                                offices and in any other places where
                                the parties involved in the processing are located. It means that this information may
                                be transferred to — and
                                maintained on — computers located outside of Your state, province, country or other
                                governmental jurisdiction where the
                            ...
                            <h2 class="text-warning">Disclosure of Your Personal Data</h2>
                            <h3 class="text-success">Business Transactions</h3>
                            <p>
                                If the Company is involved in a merger, acquisition or asset sale, Your Personal Data
                                may be transferred. We will
                                provide notice before Your Personal Data is transferred and becomes subject to a
                                different Privacy Policy.
                            </p>
                            <h3 class="text-success">Law enforcement</h3>
                            <p>Under certain circumstances, the Company may be required to disclose Your Personal Data
                                if required to do so by law or
                                in response to valid requests by public authorities (e.g. a court or a government
                                agency).</p>
                            <h3 class="text-success">Other legal requirements</h3>
                            ...
                            <h3 class="text-success">Security of Your Personal Data</h3>
                            ...
                            <p>
                                ...
                                sites or services.</p>
                            <h1 class="text-primary">Changes to this Privacy Policy</h1>
                            <p>
                            ...
                            <ul>
                                <li>By email: <a href="mailto:info@hyperu.space">info@hyperu.space</a></li>
                                <li>By contact page: <a href="<c:out value="${baseUri}" />/contacts">here</a></li>
                            </ul>
                        </div>
                    </div>
