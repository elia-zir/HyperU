                ...
                <%@include file="./components/navbar.jsp" %>
                    ...
                    <div class="row page m-0 p-0">
                        <%@include file="./components/sidebar_teams.jsp" %>
                            ...
                            <!-- CEntral column to display users and ideas retrieved from the search -->
                            <div
                                class="content col-sm-12 col-xs-12 col-md-12 col-lg-6 d-flex flex-column align-items-center">
                                <h1 class="mb-3">Users</h1>
                                <div class="d-grid gap-3 justify-content-center w-100 mb-5" id="users"></div>
                                <h1 class="mt-5 mb-3">Ideas</h1>
                    ...
                    <%@include file="./components/footer.jsp" %>
                        ...
                        <script src="<c:out value="${baseUri}" />/js/components/user_result.js"></script>
                        ...
                        <script src="<c:out value="${baseUri}" />/js/search.js"></script>
            </body>
        </html>